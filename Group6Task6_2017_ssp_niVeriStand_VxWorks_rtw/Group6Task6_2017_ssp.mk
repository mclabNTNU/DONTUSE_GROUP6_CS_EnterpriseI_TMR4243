...
#
# File    : Group6Task6_2017_ssp.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= Group6Task6_2017_ssp
MODULES         		:= Group6Task6_2017_ssp_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= Group6Task6_2017_ssp.mk
...
MODELLIB                  := Group6Task6_2017_ssplib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\Documents\GitHub\GROUP6_CS_EnterpriseI_TMR4243\Group6Task6_2017_ssp_niVeriStand_VxWorks_rtw
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\Documents\GitHub\GROUP6_CS_EnterpriseI_TMR4243
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\Documents\GitHub\GROUP6_CS_EnterpriseI_TMR4243\SIMULI~1
