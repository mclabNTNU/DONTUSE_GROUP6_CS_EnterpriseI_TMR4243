...
#
# File    : Group6Task6_2017Test.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= Group6Task6_2017Test
MODULES         		:= Group6Task6_2017Test_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= Group6Task6_2017Test.mk
...
MODELLIB                  := Group6Task6_2017Testlib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP6~1\SIMULI~1\Group6Task6_2017Test_niVeriStand_VxWorks_rtw
