...
#ifndef RTW_HEADER_Group6Task6_2017Test_h_
#define RTW_HEADER_Group6Task6_2017Test_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef Group6Task6_2017Test_COMMON_INCLUDES_
# define Group6Task6_2017Test_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* Group6Task6_2017Test_COMMON_INCLUDES_ */

#include "Group6Task6_2017Test_types.h"
...
#define Group6Task6_2017Test_rtModel   RT_MODEL_Group6Task6_2017Test_T

/* Block signals for system '<Root>/MATLAB Function2' */
typedef struct {
  real_T u_out;                        /* '<Root>/MATLAB Function2' */
} B_MATLABFunction2_Group6Task6_T;
...
typedef struct {
  ...
  real_T L1;                           /* '<Root>/L1' */
  real_T Arriow_up;                    /* '<Root>/Arriow_up' */
  real_T current_condition;            /* '<Root>/MATLAB Function4' */
  real_T alpha;                        /* '<Root>/MATLAB Function1' */
  B_MATLABFunction2_Group6Task6_T sf_MATLABFunction3;/* '<Root>/MATLAB Function3' */
  B_MATLABFunction2_Group6Task6_T sf_MATLABFunction2;/* '<Root>/MATLAB Function2' */
} B_Group6Task6_2017Test_T;
...
typedef struct {
  ...
  real_T Arriow_up_DWORK1;             /* '<Root>/Arriow_up' */
  real_T Select_DWORK1;                /* '<Root>/Select ' */
  real_T L1_DWORK1_g;                  /* '<Root>/L1 ' */
  real_T L1Arrow_up_DWORK1;            /* '<Root>/L1 Arrow_up' */
  ...
  uint8_T L1_DWORK2[21];               /* '<Root>/L1' */
  uint8_T omega_VSP2_DWORK2[21];       /* '<Root>/omega_VSP2' */
  uint8_T Arriow_up_DWORK2[21];        /* '<Root>/Arriow_up' */
  uint8_T Select_DWORK2[21];           /* '<Root>/Select ' */
  uint8_T L1_DWORK2_f[21];             /* '<Root>/L1 ' */
  uint8_T L1Arrow_up_DWORK2[21];       /* '<Root>/L1 Arrow_up' */
...
} DW_Group6Task6_2017Test_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Group6Task6_2017Test_B
#define BlockIO                        B_Group6Task6_2017Test_T
#define rtP                            Group6Task6_2017Test_P
#define Parameters                     P_Group6Task6_2017Test_T
#define rtDWork                        Group6Task6_2017Test_DW
#define D_Work                         DW_Group6Task6_2017Test_T

/* Parameters (auto storage) */
struct P_Group6Task6_2017Test_T_ {
  ...
  real_T Memory1_X0;                   /* Expression: 2
                                        ...
                                        */
  real_T Constant_Value[2];            /* Expression:  [1.165*2 2.629 ]
  ...
  real_T omega_VSP2_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/omega_VSP2'
                                        */
  real_T Arriow_up_P1;                 /* Expression: width
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Arriow_up_P2;                 /* Expression: dtype
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Arriow_up_P3;                 /* Expression: portnum
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Arriow_up_P4;                 /* Expression: stime
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Arriow_up_P5;                 /* Expression: stype
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Arriow_up_P6;                 /* Expression: btype
                                        * Referenced by: '<Root>/Arriow_up'
                                        */
  real_T Select_P1;                    /* Expression: width
                                        * Referenced by: '<Root>/Select '
  ...
  real_T L1_P1_d;                      /* Expression: width
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1_P2_b;                      /* Expression: dtype
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1_P3_m;                      /* Expression: portnum
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1_P4_k;                      /* Expression: stime
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1_P5_i;                      /* Expression: stype
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1_P6_a;                      /* Expression: btype
                                        * Referenced by: '<Root>/L1 '
                                        */
  real_T L1Arrow_up_P1;                /* Expression: width
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
  real_T L1Arrow_up_P2;                /* Expression: dtype
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
  real_T L1Arrow_up_P3;                /* Expression: portnum
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
  real_T L1Arrow_up_P4;                /* Expression: stime
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
  real_T L1Arrow_up_P5;                /* Expression: stype
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
  real_T L1Arrow_up_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/L1 Arrow_up'
                                        */
...
struct tag_RTM_Group6Task6_2017Test_T {
  const char_T *path;
...
extern P_Group6Task6_2017Test_T Group6Task6_2017Test_P;

/* Block signals (auto storage) */
extern B_Group6Task6_2017Test_T Group6Task6_2017Test_B;

/* Block states (auto storage) */
extern DW_Group6Task6_2017Test_T Group6Task6_2017Test_DW;

/*====================*
 * External functions *
 *====================*/
extern Group6Task6_2017Test_rtModel *Group6Task6_2017Test(void);
...
extern RT_MODEL_Group6Task6_2017Test_T *const Group6Task6_2017Test_M;
 ...
 *
 * '<Root>' : 'Group6Task6_2017Test'
 * '<S1>'   : 'Group6Task6_2017Test/MATLAB Function'
 * '<S2>'   : 'Group6Task6_2017Test/MATLAB Function1'
 * '<S3>'   : 'Group6Task6_2017Test/MATLAB Function2'
 * '<S4>'   : 'Group6Task6_2017Test/MATLAB Function3'
 * '<S5>'   : 'Group6Task6_2017Test/MATLAB Function4'
 * '<S6>'   : 'Group6Task6_2017Test/Ramp'
 */
#endif                                 /* RTW_HEADER_Group6Task6_2017Test_h_ */
...
P_Group6Task6_2017Test_T rtParameter[NUMST+!TID01EQ];
P_Group6Task6_2017Test_T *param_lookup[NUMST][2] = {
...
P_Group6Task6_2017Test_T rtParameter[2];
...
extern int tid;
extern P_Group6Task6_2017Test_T* param_lookup[NUMST][2];

#else

extern P_Group6Task6_2017Test_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define Group6Task6_2017Test_P         (*param_lookup[tid][READSIDE])
#else
#define Group6Task6_2017Test_P         rtParameter[READSIDE]
#endif
#endif
#endif
