...
static void Group6Task6_2017_ssp_output(void)
{
  ...
  if (Group6Task6_2017_ssp_B.current_mode == 2.0) {
    /* '<S1>:1:3' */
    /* '<S1>:1:4' */
    rtb_tau_x = -rtb_DeadZone1 * Group6Task6_2017_ssp_P.Sat_Forces_Value[0];

    /* '<S1>:1:5' */
    rtb_DeadZone1 = rtb_DeadZone * Group6Task6_2017_ssp_P.Sat_Forces_Value[1];
    ...
    /* '<S1>:1:9' */
    rtb_DeadZone1 = rtb_DeadZone * Group6Task6_2017_ssp_P.Sat_Forces_Value[0];
  ...
  if (Group6Task6_2017_ssp_B.current_mode == 2.0) {
    ...
    /* '<S2>:1:11' */
    /* '<S2>:1:12' */
    rtb_f_vspy = 0.3875 * rtb_DeadZone1 / 0.845 - rtb_DeadZone / 0.845;

    /* '<S2>:1:13' */
    rtb_DeadZone1 = rtb_DeadZone / 0.845 - -0.4575 * rtb_DeadZone1 / 0.845;
  }
  ...
  /* '<S3>:1:4' */
  rtb_u_bt = rtb_DeadZone1 / Group6Task6_2017_ssp_P.Sat_Forces_Value[1];

  /* '<S3>:1:5' */
  Group6Task6_2017_ssp_B.alpha = rt_atan2d_snf(rtb_f_vspy, rtb_tau_x);
...
RT_MODEL_Group6Task6_2017_ssp_T *Group6Task6_2017_ssp(void)
{
  ...
  Group6Task6_2017_ssp_M->Sizes.numBlocks = (42);/* Number of blocks */
  Group6Task6_2017_ssp_M->Sizes.numBlockIO = (14);/* Number of block outputs */
  Group6Task6_2017_ssp_M->Sizes.numBlockPrms = (116);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int* TaskSampleHit)
{
  ...
  // Arriow_up2
  if (TaskSampleHit[1]) {
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_B.Arriow_up2, 0, data[index++],
      0, 0);
  } else {
    index += 1;
  }
  ...
  // L3
  if (TaskSampleHit[1]) {
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_B.L3, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  // L1 : Virtual Signal # 0
  if (TaskSampleHit[1]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&Group6Task6_2017_ssp_B.L3,0,0,
      0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[1]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&Group6Task6_2017_ssp_B.Arriow_up2,0,0,0);
  } else {
    index += 1;
  }
...
int NI_InitExternalOutputs()
{
  ...
  // L1 : Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&Group6Task6_2017_ssp_B.L3,0,0,0);
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  { 0, "group6task6_2017_ssp/Ramp/Constant1/Value", offsetof
    (P_Group6Task6_2017_ssp_T, Ramp_X0), 27, 1, 2, 0, 0 },
  ...
  { 2, "group6task6_2017_ssp/Ramp/Constant/Value", offsetof
    (P_Group6Task6_2017_ssp_T, Ramp_start), 27, 1, 2, 4, 0 },
  ...
  { 5, "group6task6_2017_ssp/Dead Zone/LowerValue", offsetof
    (P_Group6Task6_2017_ssp_T, DeadZone_Start), 27, 1, 2, 10, 0 },

  { 6, "group6task6_2017_ssp/Dead Zone/UpperValue", offsetof
    (P_Group6Task6_2017_ssp_T, DeadZone_End), 27, 1, 2, 12, 0 },

  { 7, "group6task6_2017_ssp/Dead Zone1/LowerValue", offsetof
    (P_Group6Task6_2017_ssp_T, DeadZone1_Start), 27, 1, 2, 14, 0 },

  { 8, "group6task6_2017_ssp/Dead Zone1/UpperValue", offsetof
    (P_Group6Task6_2017_ssp_T, DeadZone1_End), 27, 1, 2, 16, 0 },

  { 9, "group6task6_2017_ssp/Sat_Forces/Value", offsetof
    (P_Group6Task6_2017_ssp_T, Sat_Forces_Value), 22, 2, 2, 18, 0 },

  { 10, "group6task6_2017_ssp/Ramp/Step/Before", offsetof
    (P_Group6Task6_2017_ssp_T, Step_Y0), 27, 1, 2, 20, 0 },

  { 11, "group6task6_2017_ssp/Saturation/UpperLimit", offsetof
    (P_Group6Task6_2017_ssp_T, Saturation_UpperSat), 27, 1, 2, 22, 0 },

  { 12, "group6task6_2017_ssp/Saturation/LowerLimit", offsetof
    (P_Group6Task6_2017_ssp_T, Saturation_LowerSat), 27, 1, 2, 24, 0 },
};
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 4, "group6task6_2017_ssp/Arriow_up2", 0, "", offsetof
    (B_Group6Task6_2017_ssp_T, Arriow_up2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 8, 0 },

  { 5, "group6task6_2017_ssp/L3", 0, "", offsetof(B_Group6Task6_2017_ssp_T, L3)+
    0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 10, 0 },

  { 6, "group6task6_2017_ssp/Saturation", 0, "", offsetof
    (B_Group6Task6_2017_ssp_T, Saturation)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 12, 0 },

  { 7, "group6task6_2017_ssp/Sel_Control_Mode", 0, "current_mode", offsetof
    (B_Group6Task6_2017_ssp_T, current_mode)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 14, 0 },

  { 8, "group6task6_2017_ssp/Force2Control", 1, "alpha", offsetof
    (B_Group6Task6_2017_ssp_T, alpha)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 16,
    0 },

  { 9, "group6task6_2017_ssp/Logical Operator", 0, "", offsetof
    (B_Group6Task6_2017_ssp_T, LogicalOperator)+0*sizeof(boolean_T), BLOCKIO_SIG,
    8, 1, 2, 18, 0 },

  { 10, "group6task6_2017_ssp/Sat_Chk_VSP", 0, "u_out", offsetof
    (B_Group6Task6_2017_ssp_T, sf_Sat_Chk_VSP.u_out)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 20, 0 },

  { 11, "group6task6_2017_ssp/Sat_Chk_VSP", 1, "error", offsetof
    (B_Group6Task6_2017_ssp_T, sf_Sat_Chk_VSP.error)+0*sizeof(boolean_T),
    BLOCKIO_SIG, 8, 1, 2, 22, 0 },

  { 12, "group6task6_2017_ssp/Sat_Chk_BT", 0, "u_out", offsetof
    (B_Group6Task6_2017_ssp_T, sf_Sat_Chk_BT.u_out)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 24, 0 },

  { 13, "group6task6_2017_ssp/Sat_Chk_BT", 1, "error", offsetof
    (B_Group6Task6_2017_ssp_T, sf_Sat_Chk_BT.error)+0*sizeof(boolean_T),
    BLOCKIO_SIG, 8, 1, 2, 26, 0 },
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 9, "L1 ", 1, EXT_OUT, 1, 1, 1 },

  { 10, "L1 Arrow_up", 1, EXT_OUT, 1, 1, 1 },
...
static char* NI_CompiledModelVersion = "1.157";
static char* NI_CompiledModelDateTime = "Tue Jan 31 13:43:14 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType(&Group6Task6_2017_ssp_DW.L3_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&Group6Task6_2017_ssp_DW.L3_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType(&Group6Task6_2017_ssp_DW.L1_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&Group6Task6_2017_ssp_DW.L1_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.PosXLeft_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.select_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.PosYLeft_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.R2_continuous_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.u_BT_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.u_VSP1_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.u_VSP2_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK2");
    }

    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.alpha_VSP1_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.alpha_VSP2_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.L3_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&Group6Task6_2017_ssp_DW.L3_DWORK2");
    }

    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.omega_VSP1_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.omega_VSP2_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.CurrentMode_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.ErrorStateFlag_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.L1_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&Group6Task6_2017_ssp_DW.L1_DWORK2");
    }

    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK2, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK2");
    }

    for (count = 0; count < 21; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.NIVeriStandSignalProbe_DWORK1, count, 17, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 64; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&Group6Task6_2017_ssp_DW.NIVeriStandSignalProbe_DWORK3, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
  ...
  * clockTicks)
{
  ...
  if (discStates) {
    ...
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.u_VSP2_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.alpha_VSP2_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L3_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.ErrorStateFlag_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L1_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    for (count = 0; count < 21; count++) {
      NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.Arriow_up2_DWORK2, count,
        discStates[idx++], 17, 0);
    }
    ...
    for (count = 0; count < 21; count++) {
      NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L3_DWORK2, count,
        discStates[idx++], 17, 0);
    }
    ...
    for (count = 0; count < 21; count++) {
      NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L1_DWORK2, count,
        discStates[idx++], 17, 0);
    }

    for (count = 0; count < 21; count++) {
      NIRT_SetValueByDataType(&Group6Task6_2017_ssp_DW.L1Arrow_up_DWORK2, count,
        discStates[idx++], 17, 0);
    }
