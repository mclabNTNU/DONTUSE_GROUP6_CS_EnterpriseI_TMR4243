...
typedef struct {
  ...
  real_T Arriow_up2;                   /* '<Root>/Arriow_up2' */
  real_T L3;                           /* '<Root>/L3' */
...
typedef struct {
  ...
  real_T Arriow_up2_DWORK1;            /* '<Root>/Arriow_up2' */
...
struct P_Group6Task6_2017_ssp_T_ {
  ...
  real_T u_VSP2_P6;                    /* Expression: btype
                                        * Referenced by: '<Root>/u_VSP2'
                                        */
  real_T Arriow_up2_P1;                /* Expression: width
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
  real_T Arriow_up2_P2;                /* Expression: dtype
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
  real_T Arriow_up2_P3;                /* Expression: portnum
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
  real_T Arriow_up2_P4;                /* Expression: stime
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
  real_T Arriow_up2_P5;                /* Expression: stype
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
  real_T Arriow_up2_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/Arriow_up2'
                                        */
